...
- [random_baseline on two_digit_bottom] draws=370, k=5, hits=16/370 (4.32%), expected under fairness=5.00%, 95% CI=(2.49%, 6.93%), ROI=-22.2% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

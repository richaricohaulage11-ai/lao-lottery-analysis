...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=40/869 (4.60%), expected under fairness=5.00%, 95% CI=(3.31%, 6.22%), ROI=-17.1% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)
...
## Target: three_digit
- [random_baseline on three_digit] draws=869, k=5, hits=9/869 (1.04%), expected under fairness=0.50%, 95% CI=(0.47%, 1.96%), ROI=-81.4% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

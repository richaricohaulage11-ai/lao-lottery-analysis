...
- [random_baseline on two_digit_bottom] draws=370, k=5, hits=17/370 (4.59%), expected under fairness=5.00%, 95% CI=(2.70%, 7.25%), ROI=-17.3% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)
...
- [random_baseline on two_digit_top] draws=370, k=5, hits=13/370 (3.51%), expected under fairness=5.00%, 95% CI=(1.88%, 5.93%), ROI=-36.8% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

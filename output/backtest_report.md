...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=61/869 (7.02%), expected under fairness=5.00%, 95% CI=(5.41%, 8.93%), ROI=+26.4% -> statistically distinguishable from the random baseline
...
## Target: three_digit
- [random_baseline on three_digit] draws=869, k=5, hits=11/869 (1.27%), expected under fairness=0.50%, 95% CI=(0.63%, 2.25%), ROI=-77.2% -> statistically distinguishable from the random baseline

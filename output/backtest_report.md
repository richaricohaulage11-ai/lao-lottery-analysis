...
- [random_baseline on two_digit_bottom] draws=370, k=5, hits=21/370 (5.68%), expected under fairness=5.00%, 95% CI=(3.55%, 8.55%), ROI=+2.2% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)
...
- [random_baseline on two_digit_top] draws=370, k=5, hits=11/370 (2.97%), expected under fairness=5.00%, 95% CI=(1.49%, 5.26%), ROI=-46.5% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

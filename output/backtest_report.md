...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=45/869 (5.18%), expected under fairness=5.00%, 95% CI=(3.80%, 6.87%), ROI=-6.8% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)
...
## Target: three_digit
- [random_baseline on three_digit] draws=869, k=5, hits=8/869 (0.92%), expected under fairness=0.50%, 95% CI=(0.40%, 1.81%), ROI=-83.4% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

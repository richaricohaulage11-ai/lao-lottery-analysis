...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=47/869 (5.41%), expected under fairness=5.00%, 95% CI=(4.00%, 7.13%), ROI=-2.6% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

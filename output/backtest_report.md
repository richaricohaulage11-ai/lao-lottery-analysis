...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=37/869 (4.26%), expected under fairness=5.00%, 95% CI=(3.02%, 5.82%), ROI=-23.4% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)
...
## Target: three_digit
- [random_baseline on three_digit] draws=869, k=5, hits=4/869 (0.46%), expected under fairness=0.50%, 95% CI=(0.13%, 1.17%), ROI=-91.7% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

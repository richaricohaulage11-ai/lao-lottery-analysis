...
- [random_baseline on two_digit_top] draws=370, k=5, hits=20/370 (5.41%), expected under fairness=5.00%, 95% CI=(3.33%, 8.22%), ROI=-2.7% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

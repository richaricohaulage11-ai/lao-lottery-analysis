...
## Target: two_digit
- [random_baseline on two_digit] draws=869, k=5, hits=43/869 (4.95%), expected under fairness=5.00%, 95% CI=(3.60%, 6.61%), ROI=-10.9% -> NOT statistically distinguishable from the random baseline (consistent with no real edge)

...
from .backtest import BacktestResult, backtest_sensitivity_by_window, k_and_payout_sensitivity, PAYOUT_SCENARIOS
...
def build_dashboard_data(
    ...
    return {
        ...
        "k_payout_sensitivity": {
            ...
            "three_digit": k_and_payout_sensitivity(df, ALL_STRATEGIES, target_column="three_digit"),
        },
